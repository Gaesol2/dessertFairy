       ...
       <thead>
        ...
        <tbody>
            <tr>
               <td class="col1">번호</td>
               <td class="col2">
               <input type="text" name="n_no" class="chk" title="번호" readonly="readonly" value="${notice.n_no}">
               </td>
            </tr> 
            <tr>
               <td class="col1">제목</td>
            ...
            <tr>
               ...
               <td class="col2">
               <input type="date"  name="n_vdate" class="chk" title="공지종료일" readonly="readonly" value="${notice.n_vdate}">  
               </td>
              </tr>
            </tbody>
           <tfoot>
