...
<div id="review">
	...
	<form action="" name="reviewForm" id="myform" method="post" enctype="multipart/form-data">
		<div id="reviewWrite">
			...
			<span><input type="text" name="m_id" readonly="readonly" value="${review.m_id}" class="chkb in" size="30"></span>
		</div>
		...
		<div id="reviewPasswd">
			...
			<span><input type="text" id="r_passwd" name="r_passwd" title="비밀번호" class="chkb in" value="${review.r_passwd}" size="20"></span>
		</div>
		<div id="myBtn">
