...
<div id="contact">
  ...
  <form action="/contactupProc" name="contactForm" id="myupform" method="post">
       <div id="conWrite">
       	 <p class="spanName">제목</p>
         <span><input type="text" name="t_subject" value="${contact.t_subject}" title="제목" class="chkc in" size="30"></span>
         
         <p class="spanWrite">작성자</p>
         <span><input type="text" name="m_id" class="chkc in" title="작성자" size="30" value="${contact.m_id}" disabled="disabled"></span>
       ...
       <div id="conContent">
	      ...
	      <span>
	      	<textarea name="t_content" class="chkc" title="내용" rows="20" cols="50">${contact.t_content}</textarea>
	      </span>
       </div>
       <div id="conPasswd">
