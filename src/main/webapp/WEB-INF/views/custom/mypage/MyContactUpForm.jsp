...
<div id="contact">
	...
	<form action="" name="contactUpForm" id="myupform" method="post">
		...
		<div id="conWrite">
			...
			<span>
				<input type="text" name="t_subject" value="${contact.t_subject}" title="제목" class="chkc in" size="30">
			</span>
		
			<p class="spanWrite">작성자</p>
			<span>
				<input type="text" name="m_id" class="chkc in" title="작성자" size="30" value="${contact.m_id}" disabled="disabled">
			</span>
		</div>
