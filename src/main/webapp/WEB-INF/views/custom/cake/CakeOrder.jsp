...
<div id="cake"><!-- 케이크 예약 시작 -->
	...
	<div id="essentialBox">
		<p class="essential">케이크 예약시 안내사항을 꼭 읽어주세요!!!</p>
	</div>
	<div id="cakecontent"><!-- 안내사항 시작 -->
		...
		<div id="cakeEssential">
			<p class="cakeQuest">케이크 주문은?</p>
			<ul>
				<li class="heart1">원하는 케이크의 이미지가 있으면 사진을 첨부해주세요!</li>
				<li class="heart2">원하는 케이크의 이미지가 없을 경우 디자인은 랜덤으로 나갑니다!</li>
				<li class="heart3">요구사항이 있으면 요구사항칸에 작성해주세요!</li>
				<li class="heart4">원하시는 레터링이 있으면 레터링 적는 칸에 적어주세요!</li>
				<li class="heart5">1~3호는 레터링과 그림 둘 다 가능해요!</li>
				<li class="heart6">미니는 간단한 그림과 레터링만 가능해요!</li>
				<li class="heart7">도시락은 간단한 레터링(최대 8글자)만 가능해요!</li>
			</ul>
		</div>
	...
	<div id="Diameter">
		<p class="cakeSizeList">케이크 사이즈</p>
		<img src="../image/Diameter1.png" class="diameterImg">
		<p class="cakeSize">케이크 3호</p>
		<img src="../image/Diameter2.png" class="diameterImg">
		<p class="cakeSize">케이크 2호</p>
		<img src="../image/Diameter3.png" class="diameterImg">
		<p class="cakeSize">케이크 1호</p>
		<img src="../image/Diameter4.png" class="diameterImg">
		<p class="cakeSize">케이크 미니</p>
		<p class="cakeDetails">*미니케이크는 간단한 이미지와 레터링만 가능합니다.</p>
		<img src="../image/Diameter5.png" class="diameterImg">
		<p class="cakeSize">케이크 도시락</p>
		<p class="cakeDetails">*도시락 케이크는 작은 레터링만 가능(최대 8글자)/이미지 불가</p>
	</div>
	<div id="cakeImg">
